...
#include <jni.h>
/* Header for class com_scurab_android_nativeimage_NativeImage */

#ifndef _Included_com_scurab_android_nativeimage_NativeImage
#define _Included_com_scurab_android_nativeimage_NativeImage
#ifdef __cplusplus
extern "C" {
#endif
/*
